...
1. Представим трассу от 0 до 1000 км нак которой пять машин такси и один пассажир

2. Создаем массив $cars с пятью машинами такси, с со случайным расположением на трессе от 0 до 1000 км и случайной загрузкой (занят/свободен). 

3. Создаем переменную пассажира $passenger = rand (0, 1000)
